...
app.layout = html.Div(children=[
    ...
    html.Div(id='controls-container', className='card', children=[
...
def update_graph(selected_region):
    ...
    fig = px.line(filtered_df, x="Date", y="Sales", title=f"Pink Morsel Sales Over Time ({selected_region.capitalize()})")
